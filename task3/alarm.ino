...
//全灭
    ...
    if (data[0] == '0' && data[1] == '0')
    {
        ...
        timer.hors = k;
        Serial.println("The hour has been seted to ");
        Serial.print(k);
        refresh();
    }
    //01 调分
    if (data[0] == '0' && data[1] == '1')
    {
        int k = (data[2] - '0') * 10 + (data[3] - '0');
        timer.mins = k;
        Serial.println("The mins has been seted to ");
        Serial.print(k);
        refresh();
    }
    //10 闹钟时
    if (data[0] == '1' && data[1] == '0')
    {
        int k = (data[2] - '0') * 10 + (data[3] - '0');
        timer.alahor = k;
        Serial.println("The alarm hour has been seted to ");
        Serial.print(k);
        refresh();
    }
    //11 闹钟分
    if (data[0] == '1' && data[1] == '1')
    {
        int k = (data[2] - '0') * 10 + (data[3] - '0');
        timer.alamin = k;
        Serial.println("The alarm mins has been seted to ");
        Serial.print(k);
        refresh();
    }
    data = "";
